...
var Modal = function () {
  function Modal() {
    ...
    this.openModalButton = (0, _jquery2.default)(".o-modal");
    this.modal = (0, _jquery2.default)(".modal");
    this.closeModalButton = (0, _jquery2.default)(".c-modal");
    this.events();
  }
  ...
  _createClass(Modal, [{
    ...
    value: function openModal() {
      this.modal.addClass("m-visible");
      return false;
    }
  }, {
    key: "closeModal",
    value: function closeModal() {
      this.modal.removeClass("m-visible");
    }
  }]);
      ...
      this.itemsToReveal.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler() {
            (0, _jquery2.default)(currentItem).addClass('is-visible');
          },
          offset: that.offsets
        });
      });
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    this.sticky = (0, _jquery2.default)(".site-header");
    this.headerTrigger = (0, _jquery2.default)("._title");
    this.pageSection = (0, _jquery2.default)(".page-section");
    this.headerLinks = (0, _jquery2.default)(".top-nav a");
  ...
  _createClass(StickyHeader, [{
    ...
    key: 'createPageSection',
    value: function createPageSection() {
      var thatLinks = this;
        ...
        new Waypoint({
          ...
          handler: function handler(direction) {
            if (direction == "down") {
              ...
              (0, _jquery2.default)(thatMatchs).addClass("current");
            }
          },
          offset: "20%"
        });
...
new _revealOnScroll2.default((0, _jquery2.default)(".features-item"), "85%");
